...
set id 1
set name computeTempFPGA_fadd_32ns_32ns_32_5_full_dsp_1
...
set id 2
set name computeTempFPGA_fmul_32ns_32ns_32_4_max_dsp_1
...
set id 4
set name computeTempFPGA_fdiv_32ns_32ns_32_10_no_dsp_1
...
set id 6
set name computeTempFPGA_fptrunc_64ns_32_2_no_dsp_1
...
set id 7
set name computeTempFPGA_fpext_32ns_64_2_no_dsp_1
...
set id 9
set name computeTempFPGA_dadddsub_64ns_64ns_64_5_full_dsp_1
...
set id 10
set name computeTempFPGA_dmul_64ns_64ns_64_5_max_dsp_1
...
set id 12
set name computeTempFPGA_mul_32ns_32ns_64_1_1
...
set id 13
set name computeTempFPGA_mul_32ns_64ns_96_2_1
set corename simcore_mul
set op mul
set stage_num 2
set max_latency -1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_tIn \
    op interface \
    ports { tIn_i { I 32 vector } tIn_o { O 32 vector } tIn_o_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_tOut \
    op interface \
    ports { tOut_i { I 32 vector } tOut_o { O 32 vector } tOut_o_ap_vld { O 1 bit } } \
} "
}
